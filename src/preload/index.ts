...
const api: SalesOSApi = {
  ...
  pauseMacroRecording: () => ipcRenderer.invoke('macro:record-pause') as Promise<void>,
  resumeMacroRecording: () => ipcRenderer.invoke('macro:record-resume') as Promise<void>,
  armMacroExtraction: () => ipcRenderer.invoke('macro:record-extract') as Promise<void>,
